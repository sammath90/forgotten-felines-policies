...
This register names the individual responsible for each key function within Forgotten Felines. Every escalation path in the charity's policy suite leads to a named person in this register. It must be kept up to date whenever a trustee joins, leaves, or changes role.

---

## How to Use This Register

- **Fosterers:** Use Section 2 to find who to contact for your situation.
- **Trustees:** Use Section 1 to see the full role map and identify gaps.
- **Policies:** All policies reference roles by title — match the title here to find the named individual.

---

## Section 1: Role Directory

*Every key role mapped to a named individual. Roles marked [TBC] must be assigned before the policy suite is published.*
...
| Role | Named Individual | Notes |
|---|---|---|
| Main Social Media | Becca James | Facebook, Instagram, TikTok |
| Website Content | Becca James | Content updates |
| Website Technical | Sam Mathias | Technical maintenance |
| Insurance | Becca James | Manages charity insurance renewal and claims |
| Fundraising Lead | Becca James | Coordinates fundraising activities and events |

---

## Section 2: People Directory

*Each trustee's full list of responsibilities.*
...
## Section 3: Escalation Quick Reference

*For use by fosterers and trustees when an incident occurs.*
...
## Section 4: Roles Requiring Assignment

*The following roles must be assigned to a named individual before the policy suite is published. Until assigned, Bev Hibbert (Chair) holds responsibility by default.*
...
*This document must be reviewed annually and updated whenever a trustee joins, leaves, or changes role. Printed copies should be replaced immediately on update.*
